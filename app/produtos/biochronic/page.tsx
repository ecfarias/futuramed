...
export default function BioChronicPage() {
      ...
      <section className="bg-primary text-white py-16">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold">BioChronic</h1>
          </div>
          <p className="text-xl">Kit para Tratamento de Dor Crônica</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="h-80 bg-gray-200 relative">
                <Image
                  src="/images/biochronic-table.jpg"
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="h-80 bg-gray-200 relative">
                <Image
                  src="/images/biochronic-components.jpg"
